...
const getWeather= async (city)=>
{
    try
    {
        const response= await fetch(`https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=eab578da391fa3a77a054947c7f68bbf`,
       ...
       navigator.geolocation.getCurrentPosition((position)=>
        {
            ...
            //const proxy="https://cors-anywhere.herokuapp.com/";
             const api=`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${long}&appid=eab578da391fa3a77a054947c7f68bbf`
